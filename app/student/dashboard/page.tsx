...
import { MessagesSquare, MapPinned, BookOpen, TrendingUp } from "lucide-react";
...
export default function StudentDashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      >
        <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-success-soft text-success-soft-foreground">
        ...
        <div>
          ...
          <p className="text-sm text-muted">
            {language === "en"
              ? "Progress tracking will show up here once StudentProgress is available."
              : "El seguimiento de tu progreso aparecerá aquí cuando StudentProgress esté disponible."}
          </p>
        </div>
      </motion.div>
    </div>
